...
class HogesControllerTest < ActionController::TestCase
  ...
  test "should create hoge" do
    assert_difference('Hoge.count') do
      post :create, hoge: { coffee: @hoge.coffee, email: @hoge.email, name: @hoge.name, phone: @hoge.phone }
    end
  ...
  test "should update hoge" do
    patch :update, id: @hoge, hoge: { coffee: @hoge.coffee, email: @hoge.email, name: @hoge.name, phone: @hoge.phone }
    assert_redirected_to hoge_path(assigns(:hoge))
  end
